...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="./assets/img/evsulogo.png"> 
...
<link href="assets/dist/css/bootstrap.css" rel="stylesheet">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Hello <?=$data['name']?></a>
...
?> 
 <h4>Only the Admin have the right to change the username and password to login.</h4>
